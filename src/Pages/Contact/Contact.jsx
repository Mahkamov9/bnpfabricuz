          ...
          <div className="container">
            <div className="contact_box">
              ...
              <div className='contact_map'>
                <div><iframe src="https://yandex.uz/map-widget/v1/org/1880271867/?ll=71.669884%2C41.006400&utm_source=share&z=17"></iframe></div>
            ...
            <div className='contact_content'>
              <div>
                <IoMailUnread />
                <div>
                  <p>namimpeks.textile@gmal.com</p>
                </div>
              </div>
              <div>
              <BsTelephoneFill />
                <div>
                  <p>+998 94 171 61 70</p>
                </div>
              </div>
              <div>
              <FaFacebook />
                <div>
                  <p>namimpeks.textile</p>
                </div>
              </div>
            </div>
          </div>
